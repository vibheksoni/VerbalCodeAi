...
class InstructionsManager:
    ...
    def create_template_instructions(self, path: str = None) -> Dict[str, Any]:
        ...
        template = {
            ...
            "custom_prompts": {
                "system_prompt_suffix": "Always consider the project structure and follow best practices for the codebase.",
                "code_explanation_style": "Explain code in a step-by-step manner with examples."
            }
        }
